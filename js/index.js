...
function onAbout() {
	$(".navi-wrapper .navi-wrap > div").css({"position": "absolute", "top": $(".navi-wrapper .navi-wrap > div").position().top+"px", "left": $(".navi-wrapper .navi-wrap > div").position().left+"px"});
	$(".navi-wrapper .navi-wrap > div").css("position");
	$(".navi-wrapper .navi-wrap > div").css("top");
	$(".navi-wrapper .navi-wrap > div").css("left");
	...
	$(".navi-wrapper .navi-wrap > div:nth-child(3)").css({"bottom":"20px", "right":"50px", "font-size":"4vw", "color":"rgb(255, 195, 29, 0.6)"});
